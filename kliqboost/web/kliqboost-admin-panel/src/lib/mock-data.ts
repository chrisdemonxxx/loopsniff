...
export const adminUsers: AdminUser[] = [
  { id: 'admin1', name: 'Admin', email: 'admin@kliqboost.store', role: 'super_admin', lastLogin: '2025-01-15T10:00:00Z', status: 'active' },
  { id: 'admin2', name: 'Support Agent', email: 'support@kliqboost.store', role: 'support', lastLogin: '2025-01-15T09:00:00Z', status: 'active' },
  { id: 'admin3', name: 'Viewer', email: 'viewer@kliqboost.store', role: 'viewer', lastLogin: '2025-01-14T14:00:00Z', status: 'active' },
  { id: 'admin4', name: 'Ops Manager', email: 'ops@kliqboost.store', role: 'admin', lastLogin: '2025-01-13T11:00:00Z', status: 'inactive' },
]
